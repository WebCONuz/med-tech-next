    ...
    <form className="flex flex-col gap-y-4 w-full">
      ...
      <div className="flex items-center gap-x-4">
        ...
        <input
          id="company"
          type="text"
          className="block w-[calc(100%-120px)] outline-none border border-gray-400 duration-200 hover:border-main-color focus:border-main-color py-2 px-4 rounded-md"
        />
      </div>
      <div className="flex items-center gap-x-4">
      ...
      <div className="flex items-center gap-x-4">
        ...
        <textarea
          id="content"
          className="block w-[calc(100%-120px)] h-[100px] resize-none outline-none border border-gray-400 duration-200 hover:border-main-color focus:border-main-color py-2 px-4 rounded-md"
        ></textarea>
      </div>
      <div className="flex items-center gap-x-4">
        ...
        <input
          ...
          type="text"
          placeholder="code"
          className="block w-[80px] outline-none border border-gray-400 duration-200 hover:border-main-color focus:border-main-color py-2 px-4 rounded-md"
        />
        <img
